...
**Core feeling:** *Quiet Authority.* Like a well-tailored blazer at a cricket pavilion — present, considered, confident, never loud.
...
These are the failure modes that *every* sports platform eventually slides into. KhelSetu does not:
...
@font-face {
  ...
  src: url('/fonts/NotoSansDevanagari-Variable.woff2') format('woff2-variations');
  font-weight: 100 900;
  font-display: swap;
}
```
