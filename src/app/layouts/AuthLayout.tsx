      ...
      >
        <div className="relative hidden flex-col justify-between p-10 lg:flex animate-fade-in-up">
          ...
          <div className="relative">
            ...
            <div className="relative inline-flex items-center gap-2 rounded-full border border-[var(--border-subtle)] bg-[var(--bg-glass)] px-3 py-1 text-xs font-medium text-[var(--text-primary)] backdrop-blur dark:text-[var(--text-secondary)]">
              <Sparkles className="h-3.5 w-3.5 text-[#B8860B]" />
              Trusted by 1,200+ organizers across Nepal
            </div>
            <h1 className="mt-6 text-balance font-display text-4xl font-medium -tracking-[0.02em] leading-tight text-[var(--text-primary)] sm:text-5xl dark:text-white">
              Run your local tournament{' '}
              <span className="text-[#7F1D1D] dark:text-[#FCA5A5]">
                like a national one.
              </span>
            </h1>
            <p className="mt-4 max-w-md text-pretty text-base leading-relaxed text-[var(--text-secondary)] dark:text-[var(--text-secondary)]">
            ...
            <div className="mt-8 grid grid-cols-2 gap-3">
              {stats.map((s) => (
                ...
                >
                  ...
                  <div className="mt-0.5 text-xs font-medium text-[var(--text-tertiary)] dark:text-[var(--text-muted)]">
                    {s.label}
                  </div>
                </div>
              ))}
          ...
          <div className="flex items-center gap-2 text-sm text-[var(--text-tertiary)] dark:text-[var(--text-muted)]">
        ...
        <div className="flex flex-col p-6 sm:p-10">
          <div className="flex items-center justify-between lg:hidden">
            ...
            <Link
              to={ROUTES.HOME}
              className="text-sm font-medium text-[var(--text-tertiary)] hover:text-[var(--text-primary)] dark:text-[var(--text-muted)] dark:hover:text-white"
            >
              ← Back home
            </Link>
          </div>
          ...
          <p className="mt-6 text-center text-xs text-[var(--text-muted)] lg:hidden">
