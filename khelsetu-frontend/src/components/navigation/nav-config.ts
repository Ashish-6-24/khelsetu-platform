...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    title: 'Compete',
    items: [
      { name: 'Tournaments', href: ROUTES.TOURNAMENTS, icon: Trophy },
  ...
  },
  {
    title: 'Broadcast',
    items: [
      { name: 'Live Broadcast', href: ROUTES.LIVE_BROADCAST, icon: Video },
      { name: 'Overlays', href: ROUTES.OVERLAYS, icon: Eye },
    ],
  },
  {
    title: 'Workspace',
    items: [
      ...
      { name: 'Messages', href: ROUTES.COMMUNICATION, icon: MessageSquare },
      { name: 'Search', href: ROUTES.SEARCH, icon: ClipboardList },
    ],
  },
  {
    title: 'System',
    items: [
      { name: 'Billing', href: ROUTES.BILLING, icon: DollarSign },
      { name: 'User Roles', href: ROUTES.USER_ROLES, icon: Shield },
      { name: 'Audit Log', href: ROUTES.AUDIT_LOG, icon: ClipboardList },
