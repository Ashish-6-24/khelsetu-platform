...
export const StandingRow = ({
  ...
  return (
    ...
    >
      ...
      <span className="text-sm text-green-600 dark:text-green-400 w-12 text-center">{won}</span>
      <span className="text-sm text-red-600 dark:text-red-400 w-12 text-center">{lost}</span>
      {nrr !== undefined && (
