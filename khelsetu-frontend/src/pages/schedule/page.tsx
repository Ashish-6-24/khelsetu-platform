...
const mockSchedule: MatchSchedule[] = [
  { id: '1', home: 'Kathmandu Kings', away: 'Pokhara Warriors', date: '2024-02-01', time: '14:00', venue: 'Dasharath Stadium', status: 'scheduled' },
  { id: '2', home: 'Biratnagar Bulls', away: 'Dhangadhi Stars', date: '2024-02-01', time: '18:00', venue: 'Pokhara Stadium', status: 'scheduled' },
  { id: '3', home: 'Chitwan Rhinos', away: 'Lumbini Lions', date: '2024-02-02', time: '10:00', venue: 'Bharatpur Stadium', status: 'scheduled' },
];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1">Match calendar and scheduling</p>
      </div>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-bold text-gray-900 dark:text-white">Upcoming Matches</h3>
          </div>
        </CardHeader>
        <CardBody>
          <div className="space-y-3">
            {schedule.map((match) => (
              <div key={match.id} className="flex items-center justify-between p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <Badge variant={match.status === 'live' ? 'error' : 'default'} className="capitalize">{match.status}</Badge>
              </div>
            ))}
          </div>
        </CardBody>
