...
const PartnerLogo = ({ code }: { code: string }) => {
  switch (code) {
    case 'CAN':
      ...
      return (
        <svg viewBox="0 0 24 24" className="h-5 w-5 fill-none stroke-current" strokeWidth={1.75}>
    ...
    case 'NSC':
      ...
      return (
        <svg viewBox="0 0 24 24" className="h-5 w-5 fill-none stroke-current" strokeWidth={1.75}>
          <circle cx="12" cy="12" r="10" />
          <path d="M8,6 L16,10 L10,12 L16,16 L8,18 Z" className="fill-current/10" />
    ...
    case 'NPL':
      ...
      return (
        <svg viewBox="0 0 24 24" className="h-5 w-5 fill-none stroke-current" strokeWidth={1.75}>
          ...
          <polygon points="12,2 13,5 16,5 14,7 15,10 12,8 9,10 10,7 8,5 11,5" className="fill-current" />
        </svg>
      );
    case 'NSJF':
