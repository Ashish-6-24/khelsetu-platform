...
const CATEGORY_COLORS: Record<NewsCategory, string> = {
  ...
  cricket: 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300',
  volleyball: 'bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-300',
  basketball: 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-300',
  futsal: 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300',
  ...
  'match-reports': 'bg-indigo-100 text-indigo-800 dark:bg-indigo-900/30 dark:text-indigo-300',
  'tournament-updates': 'bg-rose-100 text-rose-800 dark:bg-rose-900/30 dark:text-rose-300',
  'player-spotlight': 'bg-teal-100 text-teal-800 dark:bg-teal-900/30 dark:text-teal-300',
};
