...
export function CertificateGenerator() {
  ...
  return (
    <>
      <CertConfetti key={confettiKey} trigger={confettiKey > 0} onComplete={() => {}} />
      ...
      <div className="space-y-6">
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
          ...
          <CertificateForm onSubmit={generateCertificate} isGenerating={isGenerating} />
        </div>
        ...
        {certificateData && (
          <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div className="space-y-3">
              <div>
                <label className="text-xs font-medium text-gray-500">Certificate ID</label>
              ...
              <div>
                <label className="text-xs font-medium text-gray-500">Verification URL</label>
        ...
        {certificateData ? (
          ...
          <div className="flex h-[560px] w-full items-center justify-center rounded-xl border-2 border-dashed border-accent-700/30 bg-accent-50/50">
            <div className="text-center text-gray-400">
              ...
              <p className="text-lg font-medium text-gray-500">No Certificate Generated</p>
              <p className="mt-1 text-sm">Fill out the form to create a premium certificate</p>
            </div>
          </div>
        )}
      </div>
